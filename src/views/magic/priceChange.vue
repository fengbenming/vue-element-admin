<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('magic.date')" width="160px" align="center">
        <template slot-scope="scope">
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.FromPrice }}</span>
        </template>
      </el-table-column>
      <el-table-column
        :label="$t('magic.toPrice')"
        prop="ToPrice"
        sortable
        width="150px"
        align="center"
      >
        <template slot-scope="scope">
          <span>{{ scope.row.ToPrice }}</span>
        </template>
      </el-table-column>
      <el-table-column
        :label="$t('magic.storage')"
        prop="Storage"
        sortable
        width="110px"
        align="center"
...
import { productPriceChangeData } from '@/api/sell'
