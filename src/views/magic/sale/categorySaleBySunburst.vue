...
<script>
import Chart from "@/components/Charts/Sunburst";
import store from "../../../store/index.js";
import { ThirdCategorySaleStaticsForSunburst } from "@/api/sell";
export default {
  store,
  name: "Sunburst",
  components: { Chart },
  ...
  methods: {
    refreshData() {
      ...
      console.log(param);
      ThirdCategorySaleStaticsForSunburst(param).then(response => {
        console.log(response);
        store.commit("sunburst/refreshChart", response);
      });
    }
  }
};
