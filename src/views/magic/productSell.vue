  ...
  methods: {
    getList() {
      if (this.listQuery.date.length == 2) {
        var fullYear = this.listQuery.date[0].getFullYear()
        var month = (this.listQuery.date[0].getMonth() + 1) > 9 ? (this.listQuery.date[0].getMonth() + 1) : '0' + (this.listQuery.date[0].getMonth() + 1)
        var day = this.listQuery.date[0].getDate() > 9 ? this.listQuery.date[0].getDate() : '0' + this.listQuery.date[0].getDate()

        this.listQuery.startDate = fullYear + '-' + month + '-' + day

        var fullYear = this.listQuery.date[1].getFullYear()
        var month = (this.listQuery.date[1].getMonth() + 1) > 9 ? (this.listQuery.date[1].getMonth() + 1) : '0' + (this.listQuery.date[1].getMonth() + 1)
        var day = this.listQuery.date[1].getDate() > 9 ? this.listQuery.date[1].getDate() : '0' + this.listQuery.date[1].getDate()
        this.listQuery.endDate = fullYear + '-' + month + '-' + day
      }
